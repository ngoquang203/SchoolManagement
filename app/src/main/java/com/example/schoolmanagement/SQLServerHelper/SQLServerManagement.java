package com.example.schoolmanagement.SQLServerHelper;
...
public class SQLServerManagement {
    private static String sql = "jdbc:jtds:sqlserver://192.168.0.219:1433;databasename=QLTH;user=dataCNPM;password=ngoquanghy123"; // dia chi ket noi
